...
def process_pdf_folder(folder_path):
    """Process all PDF files in a folder and return extracted texts."""
    pdf_texts = {}
...
async def main():
    ...
    # Step 1: Process PDFs from local folder
    pdf_folder = "/home/sandyaa2004/Try2/ch1.pdf"  # Update this path
    pdf_texts = process_pdf_folder(pdf_folder)
