...
async def upload_text_to_rag(corpus):
    ...
    response = await rag.import_files(
        corpus_name=corpus.name,  # ✅ Pass the correct corpus name
        gcs_source_uris=[GCS_URI]   # ✅ Use list format for multiple files
    )
...
if __name__ == "__main__":
    ...
    print("📢 Using GCP Project:", vertexai.global_config.project)
