...
# Create RAG retrieval source
retrieval_source = rag.VertexRagStore(rag_resources=[rag.RagResource(rag_corpus=CORPUS_ID)])

# Retrieve relevant information using RAG
response = model.generate_content(
    [Part.from_text(query)],
    generation_config={"temperature": 0.2},  # Adjust temperature as needed
    retrieval=retrieval_source,  # ✅ Corrected method for RAG retrieval
)
