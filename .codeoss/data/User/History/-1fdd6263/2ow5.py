...
response = rag.retrieval_query(
    rag_resources=[rag.RagResource(rag_corpus=corpus.name)],
    text="What is the meaning of herring?"
)

print("RAG Response Candidates:", response.candidates)  # Print retrieved content
if not response.candidates:
    print("⚠️ No relevant content retrieved. Try refining your query.")
